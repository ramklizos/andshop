        ...
        <div className='productWrapper mt-7'>
            <div className='thumb relative overflow-hidden'>
                <Link to="/" className='relative block overflow-hidden'>
                    ...
                    <img className='hoverImage absolute top-0 left-0 max-w-full w-full opacity-0' src={pdata.hover_img} alt='' />
                </Link>

                <div className='absolute top-4 left-4'>
                    <span className='inline-block text-center font-medium px-3 py-1 bg-green-800 text-white text-sm rounded-sm'>{pdata.labels}</span>
                </div>
                ...
                <div className='actions absolute top-4 right-4 z-10'>
                    ...
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" t="1569683683230" viewBox="0 0 1024 1024" version="1.1" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><defs></defs><path d="M342 88H120c-17.7 0-32 14.3-32 32v224c0 8.8 7.2 16 16 16h48c8.8 0 16-7.2 16-16V168h174c8.8 0 16-7.2 16-16v-48c0-8.8-7.2-16-16-16zM920 664h-48c-8.8 0-16 7.2-16 16v176H682c-8.8 0-16 7.2-16 16v48c0 8.8 7.2 16 16 16h222c17.7 0 32-14.3 32-32V680c0-8.8-7.2-16-16-16zM342 856H168V680c0-8.8-7.2-16-16-16h-48c-8.8 0-16 7.2-16 16v224c0 17.7 14.3 32 32 32h222c8.8 0 16-7.2 16-16v-48c0-8.8-7.2-16-16-16zM904 88H682c-8.8 0-16 7.2-16 16v48c0 8.8 7.2 16 16 16h174v176c0 8.8 7.2 16 16 16h48c8.8 0 16-7.2 16-16V120c0-17.7-14.3-32-32-32z"></path></svg>
                    </span>

                    <span className='flex justify-center items-center w-10 h-10 rounded-full bg-white text-gray-700 cursor-pointer hover:bg-orange-500 hover:text-white transition duration-200'>
                    <svg stroke="currentColor" fill="currentColor" strokeWidth="0" viewBox="0 0 512 512" height="1em" width="1em" xmlns="http://www.w3.org/2000/svg"><path d="M0 168v-16c0-13.255 10.745-24 24-24h360V80c0-21.367 25.899-32.042 40.971-16.971l80 80c9.372 9.373 9.372 24.569 0 33.941l-80 80C409.956 271.982 384 261.456 384 240v-48H24c-13.255 0-24-10.745-24-24zm488 152H128v-48c0-21.314-25.862-32.08-40.971-16.971l-80 80c-9.372 9.373-9.372 24.569 0 33.941l80 80C102.057 463.997 128 453.437 128 432v-48h360c13.255 0 24-10.745 24-24v-16c0-13.255-10.745-24-24-24z"></path></svg>
                    </span>
                </div>

                <button className='w-4/5 h-11 text-sm absolute bottom-5 left-0 right-0 z-20 bg-white text-gray-700 rounded mx-auto font-medium hover:text-orange-500'>Add to cart</button>
            </div>
        </div>
    )
}
